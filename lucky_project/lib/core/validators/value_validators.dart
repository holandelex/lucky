...
Either<ValueFailure<String>, String> validateEmptyGender(String input) {
  if (input.isNotEmpty) {
    ...
    return left(ValueFailure.invalidEmptyGender(failedValue: input));
  }
}

Either<ValueFailure<String>, String> validateHomeTown(String input) {
  if (input.isNotEmpty) {
    return right(input);
  } else {
    return left(ValueFailure.invalidHomeTown(failedValue: input));
  }
}
